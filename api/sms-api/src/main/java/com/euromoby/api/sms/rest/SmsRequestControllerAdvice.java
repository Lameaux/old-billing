...
import com.euromoby.api.sms.exception.BadRequestException;
...
public class SmsRequestControllerAdvice {
    ...
    public SmsRequestControllerAdvice() {
        ...
        exceptionMapping.put(MethodNotAllowedException.class, HttpStatus.METHOD_NOT_ALLOWED);
    }
